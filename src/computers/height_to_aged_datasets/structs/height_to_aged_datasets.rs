...
impl HeightToAgedDatasets {
    pub fn new() -> color_eyre::Result<Self> {
        Ok(HeightToAgedDatasets {
            height_to_1d_dataset: HeightToAgedDataset::new("1d", AgeRange::To(1))?,
            height_to_7d_dataset: HeightToAgedDataset::new("7d", AgeRange::To(7))?,
            height_to_1m_dataset: HeightToAgedDataset::new("1m", AgeRange::To(30))?,
            height_to_3m_dataset: HeightToAgedDataset::new("3m", AgeRange::To(3 * 30))?,
            height_to_6m_dataset: HeightToAgedDataset::new("6m", AgeRange::To(6 * 30))?,
            height_to_1y_dataset: HeightToAgedDataset::new("1y", AgeRange::To(365))?,
            height_to_2y_dataset: HeightToAgedDataset::new("2y", AgeRange::To(2 * 365))?,
            height_to_3y_dataset: HeightToAgedDataset::new("3y", AgeRange::To(3 * 365))?,
            height_to_5y_dataset: HeightToAgedDataset::new("5y", AgeRange::To(5 * 365))?,
            height_to_7y_dataset: HeightToAgedDataset::new("7y", AgeRange::To(7 * 365))?,
            height_to_10y_dataset: HeightToAgedDataset::new("10y", AgeRange::To(10 * 365))?,
            height_to_all_dataset: HeightToAgedDataset::new("all", AgeRange::Full)?,

            height_to_1d_7d_dataset: HeightToAgedDataset::new("1d_7d", AgeRange::FromTo(1, 7))?,
            height_to_7d_1m_dataset: HeightToAgedDataset::new("7d_1m", AgeRange::FromTo(7, 30))?,
            height_to_1m_3m_dataset: HeightToAgedDataset::new(
                "1m_3m",
                AgeRange::FromTo(30, 3 * 30),
            )?,
            height_to_3m_6m_dataset: HeightToAgedDataset::new(
                "3m_6m",
                AgeRange::FromTo(3 * 30, 6 * 30),
            )?,
            height_to_6m_1y_dataset: HeightToAgedDataset::new(
                "6m_1y",
                AgeRange::FromTo(6 * 30, 365),
            )?,
            height_to_1y_2y_dataset: HeightToAgedDataset::new(
                "1y_2y",
                AgeRange::FromTo(365, 2 * 365),
            )?,
            height_to_2y_3y_dataset: HeightToAgedDataset::new(
                "2y_3y",
                AgeRange::FromTo(2 * 365, 3 * 365),
            )?,
            height_to_3y_5y_dataset: HeightToAgedDataset::new(
                "3y_5y",
                AgeRange::FromTo(3 * 365, 5 * 365),
            )?,
            height_to_5y_7y_dataset: HeightToAgedDataset::new(
                "5y_7y",
                AgeRange::FromTo(5 * 365, 7 * 365),
            )?,
            height_to_7y_10y_dataset: HeightToAgedDataset::new(
                "7y_10y",
                AgeRange::FromTo(7 * 365, 10 * 365),
            )?,
            height_to_10y_all_dataset: HeightToAgedDataset::new(
                "10y_all",
                AgeRange::From(10 * 365),
            )?,

            height_to_sth_dataset: HeightToAgedDataset::new("sth", AgeRange::To(155))?,
            height_to_lth_dataset: HeightToAgedDataset::new("lth", AgeRange::From(155))?,

            height_to_yearly_datasets: (2009..=(chrono::Utc::now().year() as usize))
                .map(|year| HeightToAgedDataset::new(&year.to_string(), AgeRange::Year(year)))
                .try_collect()?,
        })
    }
