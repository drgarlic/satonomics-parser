...
use crate::{
    structs::{HeightMap, Outputs},
    utils::{export_snapshot, import_snapshot_vec},
};
...
struct SerializedBlockData(f32, IntMap<usize, Outputs>);
...
impl BlockData {
    ...
    fn import(serialized: SerializedBlockData) -> Self {
        Self {
            price: serialized.0,
