...
impl CointimeDataset {
    pub fn import(parent_path: &str) -> color_eyre::Result<Self> {
        ...
        let mut s = Self {
            ...
            cumulative_coinblocks_destroyed: BiMap::new_bin(&f("cumulative_coinblocks_destroyed")),
            coinblocks_created: BiMap::new_bin(&f("coinblocks_created")),
            cumulative_coinblocks_created: BiMap::new_bin(&f("cumulative_coinblocks_created")),
            coinblocks_stored: BiMap::new_bin(&f("coinblocks_stored")),
            cumulative_coinblocks_stored: BiMap::new_bin(&f("cumulative_coinblocks_stored")),
            liveliness: BiMap::_new_bin(&f("liveliness"), 2),
            vaultedness: BiMap::new_bin(&f("vaultedness")),
            activity_to_vaultedness_ratio: BiMap::new_bin(&f("activity_to_vaultedness_ratio")),
            concurrent_liveliness: BiMap::_new_bin(&f("concurrent_liveliness"), 2),
            concurrent_liveliness_2w_median: BiMap::new_bin(&f("concurrent_liveliness_2w_median")),
            liveliness_net_change: BiMap::new_bin(&f("liveliness_net_change")),
            liveliness_net_change_2w_median: BiMap::new_bin(&f("liveliness_net_change_2w_median")),
            vaulted_supply: BiMap::new_bin(&f("vaulted_supply")),
            vaulting_rate: BiMap::new_bin(&f("vaulting_rate")),
            active_supply: BiMap::_new_bin(&f("active_supply"), 2),
            active_supply_net_change: BiMap::new_bin(&f("active_supply_net_change")),
            active_supply_3m_net_change: BiMap::new_bin(&f("active_supply_3m_net_change")),
            cointime_adjusted_yearly_inflation_rate: BiMap::new_bin(&f(
                "cointime_adjusted_yearly_inflation_rate",
            )),
            cointime_adjusted_velocity: BiMap::new_bin(&f("cointime_adjusted_velocity")),
            thermo_cap: BiMap::new_bin(&f("thermo_cap")),
            investor_cap: BiMap::new_bin(&f("investor_cap")),
            thermo_cap_to_investor_cap_ratio: BiMap::new_bin(&f(
                "thermo_cap_to_investor_cap_ratio",
            )),
            active_price: BiMap::new_bin(&f("active_price")),
            active_cap: BiMap::new_bin(&f("active_cap")),
            vaulted_price: BiMap::new_bin(&f("vaulted_price")),
            vaulted_cap: BiMap::new_bin(&f("vaulted_cap")),
            true_market_mean: BiMap::new_bin(&f("true_market_mean")),
            true_market_deviation: BiMap::new_bin(&f("true_market_deviation")),
            true_market_net_unrealized_profit_and_loss: BiMap::new_bin(&f(
                "true_market_net_unrealized_profit_and_loss",
            )),
            investorness: BiMap::new_bin(&f("investorness")),
            producerness: BiMap::new_bin(&f("producerness")),
            cointime_value_created: BiMap::new_bin(&f("cointime_value_created")),
            cointime_value_destroyed: BiMap::new_bin(&f("cointime_value_destroyed")),
            cointime_value_stored: BiMap::new_bin(&f("cointime_value_stored")),
            total_cointime_value_created: BiMap::new_bin(&f("total_cointime_value_created")),
            total_cointime_value_destroyed: BiMap::new_bin(&f("total_cointime_value_destroyed")),
            total_cointime_value_stored: BiMap::new_bin(&f("total_cointime_value_stored")),
            cointime_price: BiMap::new_bin(&f("cointime_price")),
