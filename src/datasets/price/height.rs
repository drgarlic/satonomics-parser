...
use crate::{bitcoin::BitcoinDB, datasets::DATASETS_PATH, structs::HeightMap};
...
pub fn compute_height_to_price(
    ...
    //
    let dir = format!("{DATASETS_PATH}/price");

    fs::create_dir_all(&dir)?;

    let height_to_price = HeightMap::new(&format!("{dir}/height_to_price.json"));
