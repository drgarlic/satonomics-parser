...
pub fn fetch_1mn_prices_from_kraken() -> color_eyre::Result<HashMap<u32, f32>> {
    let body: Value =
...
pub fn fetch_daily_prices_from_kraken() -> color_eyre::Result<HashMap<String, f32>> {
    let body: Value =
        reqwest::blocking::get("https://api.kraken.com/0/public/OHLC?pair=XBTUSD&interval=1440")?
            .json()?;
